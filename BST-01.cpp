...
class bst
{
	...
	public:
		...
		void in_ord(Node *temp);      // triversal and search is same as these three only in triversal you don't need to wright cout code and in search you have to stop search at your point
...
void bst:: in_ord(Node *temp)                        // left Root right
{
	if (temp == NULL)
	{
...
void bst:: pre_ord(Node *temp)                          // Root left right
{
	if (temp == NULL)
	{
		cout<<"Tree is empty"<<endl;
...
void bst:: post_ord(Node *temp)                            // Right Root left 
{
	if (temp == NULL)
	{
		cout<<"Tree is empty"<<endl;
...
void bst:: delCaseOne(Node *temp)        // If no child present 
{
...
void bst:: delCaseTwoA(Node *temp)          //if  only left child present 
{
...
void bst:: delCaseTwoB(Node *temp)         //if  only right child present 
{
...
void bst::delCaseThree(Node *temp)                      //  If both childs are present 
{
	if (temp->data == number && temp == root)
	{
		Node *temp2 = temp;
